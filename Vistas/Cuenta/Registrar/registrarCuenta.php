...
<form action="" method="POST" enctype="multipart/form-data" class="px-4 py-3" id="formularioRegistrarse">
	...
	<div class="row">
		...
		<div class="form-group col-sm-6">
			...
			<input type="date" class="form-control form-control-sm" id="fecha" name="fecha" placeholder="Ingrese su Fecha de Nacimiento" minlength="6" required value="1989-06-03"></input>
		</div>	
	</div>	
	...
	<div id="mensajes">
		<div class="alert alert-success quitarContenedor" role="alert">
			Datos cargados correctamente!
		</div>

		<div class="alert alert-danger quitarContenedor" role="alert">
...
<script>
	...
	$(document).ready(function(){
		...
		btn_registrarse.on('click', function(e){
			...
			var mensajeSuccess = $('.alert-success');
			var mensajeDanger = $('.alert-danger');

			$.ajax({

				url : '<?= BASE ?>gestionCuenta/registrar',
